...
(async () => {
    ...
    const browser = await puppeteer.launch({
        ...
        userDataDir: 'C:\Users\NomaanManiyar\AppData\Local\Google\Chrome\User Data\Default',
    });


    const page = await browser.newPage();

    await page.goto('https://app.stormgain.com/crypto-miner/');

    await page.waitForTimeout(1000);
    await page.mouse.click(654, 300);
...
async function run() {
    ...
    await page.goto('https://app.stormgain.com/crypto-miner/', { waitUntil: 'networkidle2' })
